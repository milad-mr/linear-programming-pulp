...
ep1= [LpVariable("ep1s" + str(i),lowBound = 0,upBound=1000, cat='Continuous') for i in range(len(x))]
...
model +=  pulp.lpSum(v1+v2) -  pulp.lpSum(ep1) #pulp.lpSum([v1[i] + v2[i] - ep1[i] for i in range(len(x))] )
